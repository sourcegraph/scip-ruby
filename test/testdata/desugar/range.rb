...
def foo
  ...
  rn1 = Range.new # error: Not enough arguments provided for method `initialize` on `T::Range[T.untyped]`. Expected: `2..3`, got: `0`
  T.reveal_type(rn1) # error: Revealed type: `T::Range[T.untyped]`

  rn2 = Range.new(nil) # error: Not enough arguments provided for method `initialize` on `T::Range[T.untyped]`. Expected: `2..3`, got: `1`
  ...
  tr2 = T::Range[Integer].new # error: Not enough arguments provided for method `initialize` on `T::Range[Integer]`. Expected: `2..3`, got: `0`
