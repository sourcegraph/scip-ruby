...
class Bad < T::Struct
  prop :no_type_on_prop  # error: Not enough arguments provided for method `prop` on `T.class_of(Bad)`
  const :no_type_on_const  # error: Not enough arguments provided for method `const` on `T.class_of(Bad)`
end
