...
class MixinStruct
  ...
  MyKeywordInitStruct = Struct.new(:x, keyword_init: true) do
    ...
    self.new.x
    self.new.foo
    self.new(1, 2) # error: Too many positional arguments provided for method `initialize` on `MixinStruct::MyKeywordInitStruct`. Expected: `0`, got: `2`
  ...
  MyKeywordInitStruct.new(1, 2) # error: Too many positional arguments provided for method `initialize` on `MixinStruct::MyKeywordInitStruct`. Expected: `0`, got: `2`
...
class Main
    def main
        ...
        RealStruct::KeywordInit.new(1, 2) # error: Too many positional arguments provided for method `initialize` on `RealStruct::KeywordInit`. Expected: `0`, got: `2`
