...
#         ^^^^ reference local 1$877087803
     text = "\xc3("
#    ^^^^ reference (write) local 1$877087803
...
#    | ```
     puts binary_symbol
#    ^^^^ reference [..] Kernel#puts().
#         ^^^^^^^^^^^^^ reference local 2$877087803
     bytes = ["\xff", "é"]
#    ^^^^^ definition local 3$877087803
#    documentation
#    | ```ruby
