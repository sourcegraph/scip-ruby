...
#    ^ definition [..] Object#f().
   s = S.new(prop_i: 3)
#  ^ definition local 1$2046155767
#      ^ reference [..] S#
#        ^^^ reference [..] S#initialize().
   _ = s.prop_i.to_s + s.const_s + s.const_f.to_s + s.serialize.to_s
#  ^ definition local 3$2046155767
#      ^ reference local 1$2046155767
#        ^^^^^^ reference [..] S#prop_i().
...
#    ^ definition [..] Object#g().
   p = POINT.new(0, 1)
#  ^ definition local 1$2029378148
#      ^^^^^ reference [..] POINT#
#            ^^^ reference [..] POINT#initialize().
   a = p.array
#  ^ definition local 3$2029378148
#      ^ reference local 1$2029378148
#        ^^^^^ reference [..] POINT#array().
   px = p.x
#  ^^ definition local 4$2029378148
#       ^ reference local 1$2029378148
#         ^ reference [..] POINT#x().
   return
 end
