...
#             ^^^^^ definition local 1$2730911561
#                     ^^^ definition local 2$2730911561
     value + blk.call
#    ^^^^^ reference local 1$2730911561
#          ^ reference [..] Integer#+().
#            ^^^ reference local 2$2730911561
...
#            ^^^^^ definition local 1$3752390580
     value
#    ^^^^^ reference local 1$3752390580
   end
...
#              ^^^^^ definition local 1$2455876271
#                      ^^^ definition local 2$2455876271
     blk.call(value)
#    ^^^ reference local 2$2455876271
#        ^^^^ reference [..] Proc1#call().
#             ^^^^^ reference local 1$2455876271
   end
...
#            ^^^^^ definition local 1$3942458021
#                   ^^^^^ definition local 2$3942458021
#                           ^^^ definition local 3$3942458021
     target(value, &blk)
#    ^^^^^^ reference [..] WrappedCalls#target().
#           ^^^^^ reference local 2$3942458021
#                   ^^^ reference local 3$3942458021
     other.target(value, &blk)
#    ^^^^^ reference local 1$3942458021
#          ^^^^^^ reference [..] WrappedCalls#target().
#                 ^^^^^ reference local 2$3942458021
#                         ^^^ reference local 3$3942458021
     target(*[value], &blk)
...
#                ^ definition local 1$1218810765
     target(1, &)
#    ^^^^^^ reference [..] WrappedCalls#target().
#              ^ reference local 1$1218810765
     target(*[1], &)
#    ^^^^^^ reference [..] WrappedCalls#target().
#                 ^ reference local 1$1218810765
   end
...
#              ^^^^^ definition local 1$3841598565
     convert(*[value], &:to_s)
#    ^^^^^^^ reference [..] WrappedCalls#convert().
#              ^^^^^ reference local 1$3841598565
...
#              ^^^^^ definition local 1$3266201453
#                     ^^^^^ definition local 2$3266201453
     array[0]
#    ^^^^^ reference local 1$3266201453
#         ^ reference [..] Array#`[]`().
     array[*[0]]
#    ^^^^^ reference local 1$3266201453
#         ^ reference [..] Array#`[]`().
...
#                 ^^^^^ definition local 1$1036387419
#                         ^^^ definition local 2$1036387419
     other.target(1, &blk)
#    ^^^^^ reference local 1$1036387419
#                     ^^^ reference local 2$1036387419
     other.target(*[1], &blk)
#    ^^^^^ reference local 1$1036387419
#                        ^^^ reference local 2$1036387419
