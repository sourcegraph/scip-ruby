...
struct LocOffsets {
    ...
    LocOffsets() noexcept : beginLoc{INVALID_POS_LOC}, endLoc{INVALID_POS_LOC} {}

    LocOffsets(uint32_t beginLoc, uint32_t endLoc) noexcept : beginLoc{beginLoc}, endLoc{endLoc} {
