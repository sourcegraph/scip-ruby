...
public:
    ...
    // HACK: This is for allowing scip-ruby access to ClassDef values.
    virtual void typecheckClass(const core::GlobalState &, core::FileRef file, ast::ClassDef &) const = 0;
